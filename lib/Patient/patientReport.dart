                    ...
                    IconButton(
                      padding: EdgeInsets.zero,
                        ...
                        onPressed: (){
                          Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const UploadRecord())
                          );
                        },
                        icon: const Icon(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => PdfPatientReportView(patientUploadedReport: patientUploadedReport!))
                        );
                      },
                       ...
                       if(doctorUploadedReports.length>1 && index>0){
                         ...
                         return GestureDetector(
                           onTap: (){
                              Navigator.push(
                                  context,
                                MaterialPageRoute(builder: (context) => PdfDoctorReportView(doctorUploadedReport: doctorUploadedReports[index]))
                              );
                           },
                             child: DoctorUploadedReportCard(
                                 doctorUploadedReport: doctorUploadedReports[index],
                                 sameDate: sameDate
                             )
                         );
                       }
