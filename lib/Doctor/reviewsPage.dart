...
class _ReviewsPageState extends State<ReviewsPage> {
  ...
  Future<void> fetchAvgRating() async{
    // final user = FirebaseFirestore.instance.collection('doctors').doc(currentUser!.uid);
  ...
  Future<List<ReviewModel>> getReviews() async{
    ...
    // final documents = FirebaseFirestore.instance.collection('doctors').doc(currentUser!.uid).collection('reviews');
    final documents = FirebaseFirestore.instance.collection('doctors').doc(widget.uid).collection('reviews');
  ...
  Future<String> fetchPatientDetails(String patientId) async{
    final document = FirebaseFirestore.instance.collection('patients').doc(patientId);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          ) : reviewsExists? ListView.builder(
