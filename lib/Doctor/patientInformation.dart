...
class _PatientInformationState extends State<PatientInformation> {
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>?> fetchPatientDetails() async {
    final userDoc = FirebaseFirestore.instance.collection('patients').doc(widget.uid);
  ...
  Future<void> pickFile() async{
    try{
      ...
      if(_report!=null){
        ...
        print('++++++++++++File Name : $_reportToDisplay+++++++++');
      }
  ...
  Future<void> uploadFile() async{
    ...
    print(widget.uid+'%%%%%%%%%%');
    final destination = 'reports/${widget.uid}/$_reportName ${dateTime.toString()}';
